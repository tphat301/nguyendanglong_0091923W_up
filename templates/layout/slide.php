                ...
                <div class="slideshow-item" owl-item-animation>
                    <a class="slideshow-image" href="<?= $v['link'] ?>" target="_blank" title="<?= $v['name' . $lang] ?>">
                        <picture>
                            ...
                            <img class="lazy w-100" onerror="this.src='<?= THUMBS ?>/1366x493x1/assets/images/noimage.png';" data-src="<?= THUMBS ?>/1366x493x1/<?= UPLOAD_PHOTO_L . $v['photo'] ?>" alt="<?= $v['name' . $lang] ?>" title="<?= $v['name' . $lang] ?>" />
                        </picture>
                    </a>
                </div>
            <?php } ?>
