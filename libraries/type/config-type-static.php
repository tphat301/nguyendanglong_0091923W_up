<?php
    ...
    $config['static'][$nametype]['height'] = 520;
    ...
    /* Slogan sản phẩm */
    $nametype = "slogan-sp";
    $config['static'][$nametype]['title_main'] = "Slogan sản phẩm";
    $config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['static'][$nametype]['name'] = true;

    /* Slogan kiến thức */
    $nametype = "slogan-kien-thuc";
    $config['static'][$nametype]['title_main'] = "Slogan kiến thức";
    $config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['static'][$nametype]['name'] = true;

    /* Slogan liên hệ */
    $nametype = "slogan-lien-he";
    $config['static'][$nametype]['title_main'] = "Slogan liên hệ";
    $config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['static'][$nametype]['name'] = true;

    /* Địa chỉ 1 */
    $nametype = "dia-chi-1";
    $config['static'][$nametype]['title_main'] = "Địa chỉ 1";
    $config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['static'][$nametype]['name'] = true;

    /* Địa chỉ 2 */
    $nametype = "dia-chi-2";
    $config['static'][$nametype]['title_main'] = "Địa chỉ 2";
    $config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['static'][$nametype]['name'] = true;
